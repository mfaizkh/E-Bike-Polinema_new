        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div
                    ...
                    <h1 class="intro-x font-bold text-2xl xl:text-3xl text-center xl:text-left">Peminjaman E-Bike</h1><br>
                    ...
                    <form action="{{ route('register') }}" class="mt-4" method="POST">
                        ...
                        <div class="intro-x mt-2">
                            <input type="email"
                                class="intro-x login__input form-control py-3 px-4 block mt-4 @error('email')
                            is-invalid
                        @enderror"
                            ...
                            @enderror
                            <input type="password"
                                class="intro-x login__input form-control py-3 px-4 block mt-4 @error('password')
                            is-invalid
                        @enderror"
                                id="pass" name="password" placeholder="Password" required>
                            @error('password')
                            ...
                            <input type="password"
                                ...
                                id="pass" name="password_confirmation" placeholder="Confirm Password" required>
