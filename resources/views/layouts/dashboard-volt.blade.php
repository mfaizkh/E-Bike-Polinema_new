...
<body>
    ...
    <nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none" style=" z-index: 1000;">
        <a class="navbar-brand me-lg-5" href="../../index.html">
            <img class="navbar-brand-dark" src="{{ asset('img/logo.svg') }}"
                alt="Volt logo" /> <img class="navbar-brand-light"
                src="{{ asset('img/logo.svg') }}" alt="Volt logo" />
        </a>
    ...
    <nav id="sidebarMenu" class="sidebar d-lg-block  text-white collapse" style=" z-index: 1000; background-color: #1e3a8a" data-simplebar>
        <div class="sidebar-inner px-4 pt-3">
            <div
                class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
                <div class="d-flex align-items-center">
                    <div class="avatar-lg me-4">
                        <img src="uploads/@auth{{ Auth::user()->wajah }}@endauth"
                        class="card-img-top rounded-circle border-white"  style="width: 50px; height:50px" alt="">
                    </div>
                    <div class="d-block">
            ...
            <ul class="nav flex-column pt-3 pt-md-0">
                    ...
                    <span class="nav-link  collapsed  d-flex justify-content-between align-items-center"
                        data-bs-toggle="collapse" data-bs-target="#submenu-components">
                            ...
                            <span>
                                ...
                                <span class="sidebar-text">Sewa</span>
                            </span>
                    </span>
                </a>
                </li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('riwayat.index') }}">
                    <span class="nav-link  collapsed  d-flex justify-content-between align-items-center"
                        data-bs-toggle="collapse" data-bs-target="#submenu-components">
                ...
                <li class="nav-item"> <a class="nav-link" href="{{ route('deposit.index') }}">
                    <span class="nav-link  collapsed  d-flex justify-content-between align-items-center"
                        data-bs-toggle="collapse" data-bs-target="#submenu-components">
                ...
                <li class="nav-item"> <a class="nav-link" href="{{ route('maps') }}">
                    <span class="nav-link  collapsed  d-flex justify-content-between align-items-center"
                        data-bs-toggle="collapse" data-bs-target="#submenu-components">
                ...
                <li class="nav-item"> <a class="nav-link" href="{{ route('profil.index') }}">
                    <span class="nav-link  collapsed  d-flex justify-content-between align-items-center"
                        data-bs-toggle="collapse" data-bs-target="#submenu-components">
